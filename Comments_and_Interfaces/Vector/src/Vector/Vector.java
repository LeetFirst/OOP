...
public class Vector {
     ...
     * и принимает на вход два обекта класса Vector.
     * @param v1 Первый объект класса Vector
     * @param v2 Второй объект класса Vector
     * @return double
     */
    ...
    public static void main(String[] args){
        ...
        Vector v3 = new Vector(12,25,16,7);
        System.out.println(v1 + "\n" + v2 + "\n" + v3);
        System.out.println();
        System.out.println(Vector.MultiplyNumb(v1, 10));
        System.out.println(Vector.ScalarProduct(v1,v3));
